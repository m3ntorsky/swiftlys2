...
/// </summary>
internal class EventHegrenadeDetonateImpl : TypedGameEvent<EventHegrenadeDetonate>, EventHegrenadeDetonate
{

  public EventHegrenadeDetonateImpl(IGameEvent accessor) : base(accessor)
  {
  }
