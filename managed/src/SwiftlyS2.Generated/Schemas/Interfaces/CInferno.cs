...
public partial interface CInferno : CBaseModelEntity, IConvertibleNativeHandle<CInferno> {

  static CInferno IConvertibleNativeHandle<CInferno>.From(nint handle) => new CInfernoImpl(handle);
