...
public partial interface CHitBox : ISchemaClass, IConvertibleNativeHandle<CHitBox> {

  static CHitBox IConvertibleNativeHandle<CHitBox>.From(nint handle) => new CHitBoxImpl(handle);
