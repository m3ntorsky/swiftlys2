...
public partial interface CMoverUpdateNode : CUnaryUpdateNode, IConvertibleNativeHandle<CMoverUpdateNode> {

  static CMoverUpdateNode IConvertibleNativeHandle<CMoverUpdateNode>.From(nint handle) => new CMoverUpdateNodeImpl(handle);
