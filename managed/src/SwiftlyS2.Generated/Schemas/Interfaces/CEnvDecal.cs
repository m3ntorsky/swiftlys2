...
public partial interface CEnvDecal : CBaseModelEntity, IConvertibleNativeHandle<CEnvDecal> {

  static CEnvDecal IConvertibleNativeHandle<CEnvDecal>.From(nint handle) => new CEnvDecalImpl(handle);
