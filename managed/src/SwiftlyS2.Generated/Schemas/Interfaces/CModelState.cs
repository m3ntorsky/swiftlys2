...
public partial interface CModelState : ISchemaClass, IConvertibleNativeHandle<CModelState> {

  static CModelState IConvertibleNativeHandle<CModelState>.From(nint handle) => new CModelStateImpl(handle);
