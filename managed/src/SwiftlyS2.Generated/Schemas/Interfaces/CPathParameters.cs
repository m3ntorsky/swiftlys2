...
public partial interface CPathParameters : ISchemaClass, IConvertibleNativeHandle<CPathParameters> {

  static CPathParameters IConvertibleNativeHandle<CPathParameters>.From(nint handle) => new CPathParametersImpl(handle);
