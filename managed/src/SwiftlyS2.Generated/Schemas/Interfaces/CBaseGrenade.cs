...
public partial interface CBaseGrenade : CBaseFlex, IConvertibleNativeHandle<CBaseGrenade> {

  static CBaseGrenade IConvertibleNativeHandle<CBaseGrenade>.From(nint handle) => new CBaseGrenadeImpl(handle);
