...
public partial interface CPhysFixed : CPhysConstraint, IConvertibleNativeHandle<CPhysFixed> {

  static CPhysFixed IConvertibleNativeHandle<CPhysFixed>.From(nint handle) => new CPhysFixedImpl(handle);
