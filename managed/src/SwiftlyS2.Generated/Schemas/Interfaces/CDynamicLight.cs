...
public partial interface CDynamicLight : CBaseModelEntity, IConvertibleNativeHandle<CDynamicLight> {

  static CDynamicLight IConvertibleNativeHandle<CDynamicLight>.From(nint handle) => new CDynamicLightImpl(handle);
