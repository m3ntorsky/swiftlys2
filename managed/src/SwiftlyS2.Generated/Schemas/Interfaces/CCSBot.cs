...
public partial interface CCSBot : CBot, IConvertibleNativeHandle<CCSBot> {

  static CCSBot IConvertibleNativeHandle<CCSBot>.From(nint handle) => new CCSBotImpl(handle);
