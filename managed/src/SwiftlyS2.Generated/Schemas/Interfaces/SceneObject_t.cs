...
public partial interface SceneObject_t : ISchemaClass, IConvertibleNativeHandle<SceneObject_t> {

  static SceneObject_t IConvertibleNativeHandle<SceneObject_t>.From(nint handle) => new SceneObject_tImpl(handle);
