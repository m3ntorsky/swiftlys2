...
public partial interface CMorphSetData : ISchemaClass, IConvertibleNativeHandle<CMorphSetData> {

  static CMorphSetData IConvertibleNativeHandle<CMorphSetData>.From(nint handle) => new CMorphSetDataImpl(handle);
