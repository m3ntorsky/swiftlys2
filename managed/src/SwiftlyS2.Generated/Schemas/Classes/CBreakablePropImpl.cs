...
internal partial class CBreakablePropImpl : CBasePropImpl, CBreakableProp {
  ...
  public CPropDataComponent CPropDataComponent {
    get => new CPropDataComponentImpl(_Handle + Schema.GetOffset(0xD9F5AF34ACBC1DDE));
  }
  public CEntityIOOutput OnStartDeath {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0xD9F5AF34F3ED4C8E));
  }
  public CEntityIOOutput OnBreak {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0xD9F5AF3446BFEC4F));
  }
  ...
  public CEntityIOOutput OnTakeDamage {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0xD9F5AF34CC9E35D2));
  }
  ...
  public GameTime_t PreventDamageBeforeTime {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0xD9F5AF34431B46E8));
  }
  ...
  public GameTime_t LastPhysicsInfluenceTime {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0xD9F5AF345B5C0E32));
  }
