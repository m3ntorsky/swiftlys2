...
internal partial class CTakeDamageInfoImpl : SchemaClass, CTakeDamageInfo {

  public CTakeDamageInfoImpl(nint handle) : base(handle) {
  }
  ...
  public AmmoIndex_t AmmoType {
    get => new AmmoIndex_tImpl(_Handle + Schema.GetOffset(0xE30E6228BDE8294A));
  }
