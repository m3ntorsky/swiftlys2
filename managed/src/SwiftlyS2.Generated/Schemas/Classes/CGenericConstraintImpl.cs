...
internal partial class CGenericConstraintImpl : CPhysConstraintImpl, CGenericConstraint {
  ...
  public GameTime_t BreakAfterTimeStartTimeX {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x169828480B0683A6));
  }
  public GameTime_t BreakAfterTimeStartTimeY {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x169828480C068539));
  }
  public GameTime_t BreakAfterTimeStartTimeZ {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x1698284809068080));
  }
  ...
  public GameTime_t NotifyForceLastTimeX {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x169828485B7371B4));
  }
  public GameTime_t NotifyForceLastTimeY {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x169828485C737347));
  }
  public GameTime_t NotifyForceLastTimeZ {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x169828485D7374DA));
  }
  ...
  public CEntityIOOutput NotifyForceReachedX {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x169828486707AE55));
  }
  public CEntityIOOutput NotifyForceReachedY {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x169828486607ACC2));
  }
  public CEntityIOOutput NotifyForceReachedZ {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x169828486507AB2F));
  }
