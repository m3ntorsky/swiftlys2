...
internal partial class C_INIT_RemapTransformToVectorImpl : CParticleFunctionInitializerImpl, C_INIT_RemapTransformToVector {
  ...
  public ParticleAttributeIndex_t FieldOutput {
    get => new ParticleAttributeIndex_tImpl(_Handle + Schema.GetOffset(0xED3971B7E5729606));
  }
  ...
  public CParticleTransformInput TransformInput {
    get => new CParticleTransformInputImpl(_Handle + Schema.GetOffset(0xED3971B7B3FDC289));
  }
  public CParticleTransformInput LocalSpaceTransform {
    get => new CParticleTransformInputImpl(_Handle + Schema.GetOffset(0xED3971B733F99C86));
  }
