...
internal partial class TwoBoneIKSettings_tImpl : SchemaClass, TwoBoneIKSettings_t {
  ...
  public CAnimAttachment EndEffectorAttachment {
    get => new CAnimAttachmentImpl(_Handle + Schema.GetOffset(0xBE0915516872873B));
  }
  ...
  public CAnimAttachment TargetAttachment {
    get => new CAnimAttachmentImpl(_Handle + Schema.GetOffset(0xBE091551C90DDA55));
  }
  ...
  public CAnimParamHandle PositionParam {
    get => new CAnimParamHandleImpl(_Handle + Schema.GetOffset(0xBE091551FF710245));
  }
  public CAnimParamHandle RotationParam {
    get => new CAnimParamHandleImpl(_Handle + Schema.GetOffset(0xBE09155193200F16));
  }
  ...
  public ref Vector LsFallbackHingeAxis {
    get => ref _Handle.AsRef<Vector>(Schema.GetOffset(0xBE0915517DF22B04));
  }
