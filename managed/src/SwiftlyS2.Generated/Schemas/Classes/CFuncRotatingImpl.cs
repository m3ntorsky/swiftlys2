...
internal partial class CFuncRotatingImpl : CBaseModelEntityImpl, CFuncRotating {
  ...
  public CEntityIOOutput OnStopped {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A29EA94161C44C9));
  }
  public CEntityIOOutput OnStarted {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A29EA94328D617D));
  }
  public CEntityIOOutput OnReachedStart {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A29EA945C72A242));
  }
