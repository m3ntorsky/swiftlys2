...
internal partial class CHostageImpl : CHostageExpresserShimImpl, CHostage {
  ...
  public CEntityIOOutput OnHostageBeginGrab {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A122BDF0DA44EAC));
  }
  public CEntityIOOutput OnFirstPickedUp {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A122BDFCBF60E53));
  }
  public CEntityIOOutput OnDroppedNotRescued {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A122BDFE6BC925E));
  }
  public CEntityIOOutput OnRescued {
    get => new CEntityIOOutputImpl(_Handle + Schema.GetOffset(0x1A122BDF421F0657));
  }
  public EntitySpottedState_t EntitySpottedState {
    get => new EntitySpottedState_tImpl(_Handle + Schema.GetOffset(0x1A122BDF032B547C));
  }
  ...
  public CountdownTimer ReuseTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0x1A122BDF6D7BFBA8));
  }
  ...
  public CountdownTimer JumpTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0x1A122BDF6CBF3C9A));
  }
  ...
  public CountdownTimer RepathTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0x1A122BDF4AEA977C));
  }
  public CountdownTimer InhibitDoorTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0x1A122BDF4CDEAEF5));
  }
  public CountdownTimer InhibitObstacleAvoidanceTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0x1A122BDF6310A196));
  }
  public CountdownTimer WiggleTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0x1A122BDFEDBA9421));
  }
  ...
  public GameTime_t LastGrabTime {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x1A122BDFCF347506));
  }
  ...
  public GameTime_t RescueStartTime {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x1A122BDF6085D94B));
  }
  public GameTime_t GrabSuccessTime {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x1A122BDF2EA3F531));
  }
  public GameTime_t DropStartTime {
    get => new GameTime_tImpl(_Handle + Schema.GetOffset(0x1A122BDF61FA47CF));
  }
