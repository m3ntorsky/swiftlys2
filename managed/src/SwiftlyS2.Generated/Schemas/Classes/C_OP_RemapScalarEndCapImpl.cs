...
internal partial class C_OP_RemapScalarEndCapImpl : CParticleFunctionOperatorImpl, C_OP_RemapScalarEndCap {
  ...
  public ParticleAttributeIndex_t FieldInput {
    get => new ParticleAttributeIndex_tImpl(_Handle + Schema.GetOffset(0x73A6F7F1AE775669));
  }
  public ParticleAttributeIndex_t FieldOutput {
    get => new ParticleAttributeIndex_tImpl(_Handle + Schema.GetOffset(0x73A6F7F1E5729606));
  }
