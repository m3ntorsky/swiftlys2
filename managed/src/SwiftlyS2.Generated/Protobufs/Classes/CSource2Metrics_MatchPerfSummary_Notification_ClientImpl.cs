...
{
  public CSource2Metrics_MatchPerfSummary_Notification_ClientImpl(nint handle): base(handle)
  {
  }
  ...
  { get => new CMsgSource2VProfLiteReportImpl(NativeNetMessages.GetNestedMessage(GetHandle(), "profile")); }
