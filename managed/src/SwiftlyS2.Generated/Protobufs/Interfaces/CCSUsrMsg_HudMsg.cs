...
public interface CCSUsrMsg_HudMsg : ITypedProtobuf<CCSUsrMsg_HudMsg>, INetMessage<CCSUsrMsg_HudMsg>
{
  ...
  static CCSUsrMsg_HudMsg ITypedProtobuf<CCSUsrMsg_HudMsg>.Wrap(nint handle) => new CCSUsrMsg_HudMsgImpl(handle);
