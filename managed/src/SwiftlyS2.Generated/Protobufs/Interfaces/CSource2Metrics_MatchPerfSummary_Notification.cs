...
{
  static CSource2Metrics_MatchPerfSummary_Notification ITypedProtobuf<CSource2Metrics_MatchPerfSummary_Notification>.Wrap(nint handle) => new CSource2Metrics_MatchPerfSummary_NotificationImpl(handle);
