...
public interface CMsgTEBeamRing : ITypedProtobuf<CMsgTEBeamRing>, INetMessage<CMsgTEBeamRing>
{
  static int INetMessage<CMsgTEBeamRing>.MessageId => 405;
  
  static string INetMessage<CMsgTEBeamRing>.MessageName => "CMsgTEBeamRing";

  static CMsgTEBeamRing ITypedProtobuf<CMsgTEBeamRing>.Wrap(nint handle) => new CMsgTEBeamRingImpl(handle);
