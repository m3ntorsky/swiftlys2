...
public interface CCSUsrMsg_KillCam : ITypedProtobuf<CCSUsrMsg_KillCam>, INetMessage<CCSUsrMsg_KillCam>
{
  ...
  static CCSUsrMsg_KillCam ITypedProtobuf<CCSUsrMsg_KillCam>.Wrap(nint handle) => new CCSUsrMsg_KillCamImpl(handle);
