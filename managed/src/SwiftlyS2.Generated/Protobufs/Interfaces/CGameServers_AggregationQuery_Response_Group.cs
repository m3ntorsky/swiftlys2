...
{
  static CGameServers_AggregationQuery_Response_Group ITypedProtobuf<CGameServers_AggregationQuery_Response_Group>.Wrap(nint handle) => new CGameServers_AggregationQuery_Response_GroupImpl(handle);
