...
public interface CCLCMsg_Diagnostic : ITypedProtobuf<CCLCMsg_Diagnostic>, INetMessage<CCLCMsg_Diagnostic>
{
  ...
  static CCLCMsg_Diagnostic ITypedProtobuf<CCLCMsg_Diagnostic>.Wrap(nint handle) => new CCLCMsg_DiagnosticImpl(handle);
