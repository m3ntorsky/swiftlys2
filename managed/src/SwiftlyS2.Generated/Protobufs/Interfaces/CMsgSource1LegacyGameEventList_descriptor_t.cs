...
{
  static CMsgSource1LegacyGameEventList_descriptor_t ITypedProtobuf<CMsgSource1LegacyGameEventList_descriptor_t>.Wrap(nint handle) => new CMsgSource1LegacyGameEventList_descriptor_tImpl(handle);
