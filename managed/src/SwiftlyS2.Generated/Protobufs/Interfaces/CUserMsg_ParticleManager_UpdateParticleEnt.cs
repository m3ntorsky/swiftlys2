...
{
  static CUserMsg_ParticleManager_UpdateParticleEnt ITypedProtobuf<CUserMsg_ParticleManager_UpdateParticleEnt>.Wrap(nint handle) => new CUserMsg_ParticleManager_UpdateParticleEntImpl(handle);
