...
{
  static CWorkshop_AddSpecialPayment_Request ITypedProtobuf<CWorkshop_AddSpecialPayment_Request>.Wrap(nint handle) => new CWorkshop_AddSpecialPayment_RequestImpl(handle);
