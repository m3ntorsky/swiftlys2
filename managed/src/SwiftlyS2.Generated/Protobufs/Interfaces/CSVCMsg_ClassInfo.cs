...
public interface CSVCMsg_ClassInfo : ITypedProtobuf<CSVCMsg_ClassInfo>, INetMessage<CSVCMsg_ClassInfo>
{
  ...
  static CSVCMsg_ClassInfo ITypedProtobuf<CSVCMsg_ClassInfo>.Wrap(nint handle) => new CSVCMsg_ClassInfoImpl(handle);
