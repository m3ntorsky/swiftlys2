...
#ifndef src_api_memory_hooks_vfunction_h
#define src_api_memory_hooks_vfunction_h
...
public:
    ...
    virtual void SetHookFunction(const std::string& interface, int index, const std::string& args, const char return_value) = 0;
    virtual void SetHookFunction(void* instance, int index, const std::string& args, const char return_value, bool is_vtable) = 0;
