...
internal partial class CBarnLight : CBaseModelEntity, IBarnLight {
  ...
  public CBarnLight(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public IGameTime_t LightStyleStartTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0xB5E331D1A3B159A3));
  }
  ...
  public IEntityIOOutput StyleEvent {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xB5E331D15EEF4062));
  }
  ...
  public ref CUtlVector< uint16 > VisClusters {
    get => ref _Handle.AsRef<CUtlVector< uint16 >>(Schema.GetOffset(0xB5E331D19E97C0CE));
  }
