...
internal partial class C_INIT_CreateSequentialPath : CParticleFunctionInitializer, IC_INIT_CreateSequentialPath {
  ...
  public IPathParameters PathParams {
    get => new CPathParameters(_Handle + Schema.GetOffset(0xBCADEDE23C10092C));
  }
