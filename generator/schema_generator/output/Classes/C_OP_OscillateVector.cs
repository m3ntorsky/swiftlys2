...
internal partial class C_OP_OscillateVector : CParticleFunctionOperator, IC_OP_OscillateVector {

  public C_OP_OscillateVector(nint handle) : base(handle) {
  }

  public C_OP_OscillateVector(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public IParticleAttributeIndex_t Field {
    get => new ParticleAttributeIndex_t(_Handle + Schema.GetOffset(0xEECAE90AC257B93B));
  }
  ...
  public IPerParticleFloatInput OscMult {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0xEECAE90A16278E94));
  }
  public IPerParticleFloatInput OscAdd {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0xEECAE90A7B38A63D));
  }
  public IPerParticleFloatInput RateScale {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0xEECAE90A58CBF9C1));
  }
