...
internal partial class C_INIT_PositionWarp : CParticleFunctionInitializer, IC_INIT_PositionWarp {
  ...
  public IParticleCollectionVecInput WarpMax {
    get => new CParticleCollectionVecInput(_Handle + Schema.GetOffset(0x15BDD34F0D76E147));
  }
