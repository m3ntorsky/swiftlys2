...
internal partial class CScriptedSequence : CBaseEntity, IScriptedSequence {
  ...
  public IGameTime_t StartTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0xBB0C45ED6330E7EE));
  }
  ...
  public IEntityIOOutput OnBeginSequence {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xBB0C45ED4EFCFF18));
  }
  public IEntityIOOutput OnActionStartOrLoop {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xBB0C45ED709BE9C5));
  }
  public IEntityIOOutput OnEndSequence {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xBB0C45ED1F7AD018));
  }
  public IEntityIOOutput OnPostIdleEndSequence {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xBB0C45ED7770824C));
  }
  public IEntityIOOutput OnCancelSequence {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xBB0C45ED3DF39D63));
  }
  public IEntityIOOutput OnCancelFailedSequence {
