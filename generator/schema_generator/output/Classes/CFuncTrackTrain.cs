...
internal partial class CFuncTrackTrain : CBaseModelEntity, IFuncTrackTrain {

  public CFuncTrackTrain(nint handle) : base(handle) {
  }

  public CFuncTrackTrain(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public IGameTime_t NextMoveSoundTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x416637FB05BD176B));
  }
  ...
  public IEntityIOOutput OnStart {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0x416637FBC3FE848C));
  }
  public IEntityIOOutput OnNext {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0x416637FBFE51ADC1));
  }
  public IEntityIOOutput OnArrivedAtDestinationNode {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0x416637FBCAE21100));
  }
  ...
  public IGameTime_t SpeedChangeTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x416637FBCC334417));
  }
  ...
  public IGameTime_t NextMPSoundTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x416637FB251847DB));
  }
