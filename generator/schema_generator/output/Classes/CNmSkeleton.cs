...
internal partial class CNmSkeleton : SchemaClass, INmSkeleton {
  ...
  public CNmSkeleton(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< int32 > ParentIndices {
    get => ref _Handle.AsRef<CUtlVector< int32 >>(Schema.GetOffset(0xC923251480CFB2AA));
  }
