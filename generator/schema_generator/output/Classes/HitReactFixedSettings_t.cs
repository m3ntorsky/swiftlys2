...
internal partial class HitReactFixedSettings_t : SchemaClass, IHitReactFixedSettings_t {

  public HitReactFixedSettings_t(nint handle) : base(handle) {
  }

  public HitReactFixedSettings_t(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
