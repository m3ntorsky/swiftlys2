...
internal partial class CParticleSystem : CBaseModelEntity, IParticleSystem {
  ...
  public CParticleSystem(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }

  public ISchemaFixedString SnapshotFileName {
    get => new SchemaFixedString(_Handle + Schema.GetOffset(0x8F6D2B258D2636C1));
  }
  ...
  public IGameTime_t StartTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x8F6D2B2567FE9DC4));
  }
  ...
  public ISchemaFixedArray<Vector> ServerControlPoints {
    get => new SchemaFixedArray<Vector>(_Handle + Schema.GetOffset(0x8F6D2B2561386048));
  }
  public ISchemaFixedArray<uint8> ServerControlPointAssignments {
    get => new SchemaFixedArray<uint8>(_Handle + Schema.GetOffset(0x8F6D2B25E9DEDAC8));
  }
  public ISchemaFixedArray<CHandle< CBaseEntity >> ControlPointEnts {
    get => new SchemaFixedArray<CHandle< CBaseEntity >>(_Handle + Schema.GetOffset(0x8F6D2B25ECA36598));
  }
  ...
  public ISchemaFixedArray<CUtlSymbolLarge> ControlPointNames {
    get => new SchemaFixedArray<CUtlSymbolLarge>(_Handle + Schema.GetOffset(0x8F6D2B258DBFEC78));
  }
