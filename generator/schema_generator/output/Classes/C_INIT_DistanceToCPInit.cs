...
internal partial class C_INIT_DistanceToCPInit : CParticleFunctionInitializer, IC_INIT_DistanceToCPInit {

  public C_INIT_DistanceToCPInit(nint handle) : base(handle) {
  }

  public C_INIT_DistanceToCPInit(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }

  public IParticleAttributeIndex_t FieldOutput {
    get => new ParticleAttributeIndex_t(_Handle + Schema.GetOffset(0x59C1B9D5E5729606));
  }
  public IPerParticleFloatInput InputMin {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0x59C1B9D5E88A0D0F));
  }
  public IPerParticleFloatInput InputMax {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0x59C1B9D5D6766901));
  }
  public IPerParticleFloatInput OutputMin {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0x59C1B9D55F8D7716));
  }
  public IPerParticleFloatInput OutputMax {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0x59C1B9D551A0E8C4));
  }
  ...
  public ISchemaFixedString CollisionGroupName {
    get => new SchemaFixedString(_Handle + Schema.GetOffset(0x59C1B9D5D58A3195));
  }
  ...
  public IPerParticleFloatInput MaxTraceLength {
    get => new CPerParticleFloatInput(_Handle + Schema.GetOffset(0x59C1B9D5543C3798));
  }
