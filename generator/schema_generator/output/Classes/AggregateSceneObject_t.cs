...
internal partial class AggregateSceneObject_t : SchemaClass, IAggregateSceneObject_t {
  ...
  public AggregateSceneObject_t(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< uint16 > VisClusterMembership {
    get => ref _Handle.AsRef<CUtlVector< uint16 >>(Schema.GetOffset(0xEF81F2D4F2C828CD));
  }
