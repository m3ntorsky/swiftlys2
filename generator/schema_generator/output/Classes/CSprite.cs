...
internal partial class CSprite : CBaseModelEntity, ISprite {
  ...
  public IGameTime_t ScaleTimeStart {
    get => new GameTime_t(_Handle + Schema.GetOffset(0xAAF88CE303EA4A2E));
  }
  ...
  public IGameTime_t BrightnessTimeStart {
    get => new GameTime_t(_Handle + Schema.GetOffset(0xAAF88CE3478AFDAF));
  }
