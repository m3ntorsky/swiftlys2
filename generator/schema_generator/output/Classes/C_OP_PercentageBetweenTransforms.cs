...
internal partial class C_OP_PercentageBetweenTransforms : CParticleFunctionOperator, IC_OP_PercentageBetweenTransforms {

  public C_OP_PercentageBetweenTransforms(nint handle) : base(handle) {
  }

  public C_OP_PercentageBetweenTransforms(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }

  public IParticleAttributeIndex_t FieldOutput {
    get => new ParticleAttributeIndex_t(_Handle + Schema.GetOffset(0x37F3E6E6E5729606));
  }
  ...
  public IParticleTransformInput TransformStart {
    get => new CParticleTransformInput(_Handle + Schema.GetOffset(0x37F3E6E6D94FA7F9));
  }
  public IParticleTransformInput TransformEnd {
    get => new CParticleTransformInput(_Handle + Schema.GetOffset(0x37F3E6E60C3277C8));
  }
