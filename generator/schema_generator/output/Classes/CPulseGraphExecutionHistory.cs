...
internal partial class CPulseGraphExecutionHistory : SchemaClass, IPulseGraphExecutionHistory {
  ...
  public CPulseGraphExecutionHistory(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< PulseGraphExecutionHistoryEntry_t* > History {
    get => ref _Handle.AsRef<CUtlVector< PulseGraphExecutionHistoryEntry_t* >>(Schema.GetOffset(0x2DC54ABBCFBC2CBF));
  }
