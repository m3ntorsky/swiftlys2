...
internal partial class CFishImpl : CBaseAnimGraphImpl, CFish {
  ...
  public CountdownTimer TurnTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0xC43C8434700B062B));
  }
  public ref bool TurnClockwise {
    get => ref _Handle.AsRef<bool>(Schema.GetOffset(0xC43C8434C5ECCED4));
  }
  public CountdownTimer GoTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0xC43C84348CBF9730));
  }
  public CountdownTimer MoveTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0xC43C8434254C6AC5));
  }
  public CountdownTimer PanicTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0xC43C8434D2FFC665));
  }
  public CountdownTimer DisperseTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0xC43C8434C8E05E9F));
  }
  public CountdownTimer ProximityTimer {
    get => new CountdownTimerImpl(_Handle + Schema.GetOffset(0xC43C8434ABE32A63));
  }
