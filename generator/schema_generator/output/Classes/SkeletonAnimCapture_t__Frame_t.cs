...
internal partial class SkeletonAnimCapture_t__Frame_t : SchemaClass, ISkeletonAnimCapture_t__Frame_t {
  ...
  public SkeletonAnimCapture_t__Frame_t(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< float32 > FlexControllerWeights {
    get => ref _Handle.AsRef<CUtlVector< float32 >>(Schema.GetOffset(0x413CC2EECA3D8033));
  }
