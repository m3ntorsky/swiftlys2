...
internal partial class CParticleVecInputImpl : CParticleInputImpl, CParticleVecInput {
  ...
  public ParticleAttributeIndex_t VectorAttribute {
    get => new ParticleAttributeIndex_tImpl(_Handle + Schema.GetOffset(0xD598DA0A2B36D79A));
  }
  ...
  public CParticleFloatInput FloatComponentX {
    get => new CParticleFloatInputImpl(_Handle + Schema.GetOffset(0xD598DA0A8D4D4148));
  }
  public CParticleFloatInput FloatComponentY {
    get => new CParticleFloatInputImpl(_Handle + Schema.GetOffset(0xD598DA0A8E4D42DB));
  }
  public CParticleFloatInput FloatComponentZ {
    get => new CParticleFloatInputImpl(_Handle + Schema.GetOffset(0xD598DA0A8F4D446E));
  }
  public CParticleFloatInput FloatInterp {
    get => new CParticleFloatInputImpl(_Handle + Schema.GetOffset(0xD598DA0AF81AB0BB));
  }
