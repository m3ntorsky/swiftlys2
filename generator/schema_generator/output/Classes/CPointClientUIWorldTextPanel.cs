...
internal partial class CPointClientUIWorldTextPanel : CPointClientUIWorldPanel, IPointClientUIWorldTextPanel {
  ...
  public CPointClientUIWorldTextPanel(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }

  public ISchemaFixedString MessageText {
    get => new SchemaFixedString(_Handle + Schema.GetOffset(0x9F10465EBA6E5D73));
  }
