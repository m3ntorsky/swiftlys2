...
internal partial class ConstraintSoundInfo : SchemaClass, IConstraintSoundInfo {
  ...
  public ISchemaUntypedField TravelSoundFwd {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x79068C497A65F069));
  }
  public ISchemaUntypedField TravelSoundBack {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x79068C49506B73E3));
  }
  public ISchemaUntypedField ReversalSounds {
    get => new SchemaUntypedField(_Handle, 0x79068C49F5164187, 3, 8, 8);
  }
