...
internal partial class CCSGameRules : CTeamplayRules, ICSGameRules {
  ...
  public IGameTime_t IntermissionStartTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x6295CF65AAE918DC));
  }
  public IGameTime_t IntermissionEndTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x6295CF652001CDA5));
  }
  ...
  public IGameTime_t PhaseChangeAnnouncementTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x6295CF65C4D59336));
  }
  public ref float NextUpdateTeamClanNamesTime {
    get => ref _Handle.AsRef<float>(Schema.GetOffset(0x6295CF659127E011));
  }
  public IGameTime_t LastThinkTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x6295CF65D901F6A0));
  }
