...
internal partial class CAnimationGraphVisualizerPrimitiveBase : SchemaClass, IAnimationGraphVisualizerPrimitiveBase {
  ...
  public CAnimationGraphVisualizerPrimitiveBase(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public IAnimNodeID OwningAnimNodePaths {
    get => new AnimNodeID(_Handle + Schema.GetOffset(0x5204B08461A2E55C));
  }
