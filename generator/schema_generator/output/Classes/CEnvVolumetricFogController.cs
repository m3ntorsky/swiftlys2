...
internal partial class CEnvVolumetricFogController : CBaseEntity, IEnvVolumetricFogController {
  ...
  public CEnvVolumetricFogController(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public IGameTime_t StartAnisoTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x2A8A520F84853AEE));
  }
  public IGameTime_t StartScatterTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x2A8A520F550791B8));
  }
  public IGameTime_t StartDrawDistanceTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x2A8A520F0108704D));
  }
