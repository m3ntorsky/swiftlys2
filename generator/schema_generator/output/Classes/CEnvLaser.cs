...
internal partial class CEnvLaser : CBeam, IEnvLaser {
  ...
  public ISchemaUntypedField LaserTarget {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x83A2D3C8C257F4D));
  }
  public ISprite Sprite {
    get => new CSprite(_Handle + Schema.GetOffset(0x83A2D3CEFBFA166));
  }
  public ISchemaUntypedField SpriteName {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x83A2D3C096530FF));
  }
