...
internal partial class CNmTargetWarpNode__CDefinition : CNmPoseNode::CDefinition, INmTargetWarpNode__CDefinition {

  public CNmTargetWarpNode__CDefinition(nint handle) : base(handle) {
  }

  public CNmTargetWarpNode__CDefinition(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CNmRootMotionData::SamplingMode_t SamplingMode {
    get => ref _Handle.AsRef<CNmRootMotionData::SamplingMode_t>(Schema.GetOffset(0xEA16BCF0DDB31BE3));
  }
