...
internal partial class CDecalInstance : SchemaClass, IDecalInstance {
  ...
  public IGameTime_t PlaceTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0x88CA447C1103AE77));
  }
  ...
  public IDecalInstance Next {
    get => new CDecalInstance(_Handle + Schema.GetOffset(0x88CA447C32B11E0E));
  }
  public IDecalInstance Prev {
    get => new CDecalInstance(_Handle + Schema.GetOffset(0x88CA447CD49AD9AA));
  }
