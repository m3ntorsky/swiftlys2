...
internal partial class CBeam : CBaseModelEntity, IBeam {
  ...
  public CBeam(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ISchemaFixedArray<CHandle< CBaseEntity >> AttachEntity {
    get => new SchemaFixedArray<CHandle< CBaseEntity >>(_Handle + Schema.GetOffset(0x4BCF3CE56BCDCAD1));
  }
  public IAttachmentHandle_t AttachIndex {
    get => new AttachmentHandle_t(_Handle + Schema.GetOffset(0x4BCF3CE5502E5BEC));
  }
