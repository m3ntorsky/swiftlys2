...
internal partial class CSoundOpvarSetPointEntity : CSoundOpvarSetPointBase, ISoundOpvarSetPointEntity {
  ...
  public IEntityIOOutput OnExit {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0x20C7B9D2DBE3B800));
  }
