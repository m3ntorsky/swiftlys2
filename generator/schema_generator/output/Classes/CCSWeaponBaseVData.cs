...
internal partial class CCSWeaponBaseVData : CBasePlayerWeaponVData, ICSWeaponBaseVData {
  ...
  public ISchemaUntypedField Model_AG2 {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x62FB77057CDF7624));
  }
  public ISchemaUntypedField AnimSkeleton {
  ...
  public ISchemaUntypedField TracerParticle {
  ...
  public IFiringModeFloat CycleTime {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77059EE036CE));
  }
  public IFiringModeFloat MaxSpeed {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB7705EC4C9592));
  }
  public IFiringModeFloat Spread {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77059AE479A0));
  }
  public IFiringModeFloat InaccuracyCrouch {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77058292DF17));
  }
  public IFiringModeFloat InaccuracyStand {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77054F7B5FDF));
  }
  public IFiringModeFloat InaccuracyJump {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB7705C43E18E9));
  }
  public IFiringModeFloat InaccuracyLand {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77058A797810));
  }
  public IFiringModeFloat InaccuracyLadder {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB7705EAC7C4C5));
  }
  public IFiringModeFloat InaccuracyFire {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB770598CB9215));
  }
  public IFiringModeFloat InaccuracyMove {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB7705724CFCB0));
  }
  public IFiringModeFloat RecoilAngle {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB7705D60D8F48));
  }
  public IFiringModeFloat RecoilAngleVariance {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77059780CA6B));
  }
  public IFiringModeFloat RecoilMagnitude {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77051FEEF3A5));
  }
  public IFiringModeFloat RecoilMagnitudeVariance {
    get => new CFiringModeFloat(_Handle + Schema.GetOffset(0x62FB77058FED537E));
  }
  public IFiringModeInt TracerFrequency {
    get => new CFiringModeInt(_Handle + Schema.GetOffset(0x62FB7705E42D0FCE));
  }
