...
internal partial class World_t : SchemaClass, IWorld_t {
  ...
  public World_t(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< CStrongHandleCopyable< InfoForResourceTypeCEntityLump > > EntityLumps {
    get => ref _Handle.AsRef<CUtlVector< CStrongHandleCopyable< InfoForResourceTypeCEntityLump > >>(Schema.GetOffset(0x4CBF8350E4A85021));
  }
