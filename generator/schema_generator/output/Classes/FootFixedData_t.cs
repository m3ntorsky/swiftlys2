...
internal partial class FootFixedData_t : SchemaClass, IFootFixedData_t {
  ...
  public ref VectorAligned HeelOffset {
    get => ref _Handle.AsRef<VectorAligned>(Schema.GetOffset(0x20A34186306AE608));
  }
