...
internal partial class CBaseTrailRenderer : CBaseRendererSource2, IBaseTrailRenderer {
  ...
  public IParticleCollectionRendererFloatInput StartFadeSize {
    get => new CParticleCollectionRendererFloatInput(_Handle + Schema.GetOffset(0x2FCF7FA6BA251D92));
  }
  public IParticleCollectionRendererFloatInput EndFadeSize {
    get => new CParticleCollectionRendererFloatInput(_Handle + Schema.GetOffset(0x2FCF7FA62D3FD423));
  }
