...
internal partial class CEnvBeam : CBeam, IEnvBeam {
  ...
  public ISchemaUntypedField StartEntity {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x84C6714AA162CA40));
  }
  public ISchemaUntypedField EndEntity {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x84C6714A636BA021));
  }
  ...
  public ISchemaUntypedField SpriteName {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x84C6714A096530FF));
  }
  ...
  public ISchemaUntypedField FilterName {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x84C6714A09C86445));
  }
  public ref CHandle<CBaseEntity> Filter {
    get => ref _Handle.AsRef<CHandle<CBaseEntity>>(Schema.GetOffset(0x84C6714A45D9E0B1));
  }
  public ISchemaUntypedField Decal {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0x84C6714AC8536FA6));
  }
