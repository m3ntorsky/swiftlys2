...
internal partial class C_INIT_CreationNoise : CParticleFunctionInitializer, IC_INIT_CreationNoise {

  public C_INIT_CreationNoise(nint handle) : base(handle) {
  }

  public C_INIT_CreationNoise(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }

  public IParticleAttributeIndex_t FieldOutput {
    get => new ParticleAttributeIndex_t(_Handle + Schema.GetOffset(0x89BD0037E5729606));
  }
