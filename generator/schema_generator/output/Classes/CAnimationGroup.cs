...
internal partial class CAnimationGroup : SchemaClass, IAnimationGroup {
  ...
  public CAnimationGroup(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< CStrongHandleVoid > AdditionalExtRefs {
    get => ref _Handle.AsRef<CUtlVector< CStrongHandleVoid >>(Schema.GetOffset(0x338D448349CEFD51));
  }
