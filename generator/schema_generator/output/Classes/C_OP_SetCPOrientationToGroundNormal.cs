...
internal partial class C_OP_SetCPOrientationToGroundNormal : CParticleFunctionOperator, IC_OP_SetCPOrientationToGroundNormal {
  ...
  public C_OP_SetCPOrientationToGroundNormal(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ISchemaFixedString CollisionGroupName {
    get => new SchemaFixedString(_Handle + Schema.GetOffset(0x7BC52DA3D58A3195));
  }
