...
internal partial class VPhysics2ShapeDef_t : SchemaClass, IVPhysics2ShapeDef_t {

  public VPhysics2ShapeDef_t(nint handle) : base(handle) {
  }

  public VPhysics2ShapeDef_t(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< uint16 > CollisionAttributeIndices {
    get => ref _Handle.AsRef<CUtlVector< uint16 >>(Schema.GetOffset(0xB5A68CEB86453EB2));
  }
