...
internal partial class CPathParticleRope : CBaseEntity, IPathParticleRope {
  ...
  public CPathParticleRope(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public ref CUtlVector< float32 > PathNodes_RadiusScale {
    get => ref _Handle.AsRef<CUtlVector< float32 >>(Schema.GetOffset(0xBC0C741B593CB340));
  }
