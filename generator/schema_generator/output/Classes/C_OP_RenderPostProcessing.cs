...
internal partial class C_OP_RenderPostProcessing : CParticleFunctionRenderer, IC_OP_RenderPostProcessing {
  ...
  public CStrongHandle<IInfoForResourceTypeCPostProcessingResource> PostTexture {
    get => new CStrongHandle<InfoForResourceTypeCPostProcessingResource>(_Handle + Schema.GetOffset(0xD64D179C943F8D28));
  }
