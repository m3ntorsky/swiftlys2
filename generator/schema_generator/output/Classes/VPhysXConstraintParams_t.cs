...
internal partial class VPhysXConstraintParams_t : SchemaClass, IVPhysXConstraintParams_t {
  ...
  public ref QuaternionStorage GoalOrientation {
    get => ref _Handle.AsRef<QuaternionStorage>(Schema.GetOffset(0xF2BDF6ADA64626A8));
  }
