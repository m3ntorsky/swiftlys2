...
internal partial class C_OP_OscillateScalar : CParticleFunctionOperator, IC_OP_OscillateScalar {

  public C_OP_OscillateScalar(nint handle) : base(handle) {
  }

  public C_OP_OscillateScalar(nint handle, ulong hash, bool isField, bool isNetworked) : base(handle, hash, isField, isNetworked) {
  }
  ...
  public IParticleAttributeIndex_t Field {
    get => new ParticleAttributeIndex_t(_Handle + Schema.GetOffset(0x92E728A5C257B93B));
  }
