...
internal partial class CPlantedC4 : CBaseAnimGraph, IPlantedC4 {
  ...
  public IEntityIOOutput OnBombBeginDefuse {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xE1614C81CD3D21A7));
  }
  ...
  public IGameTime_t LastSpinDetectionTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0xE1614C811BF3E683));
  }
