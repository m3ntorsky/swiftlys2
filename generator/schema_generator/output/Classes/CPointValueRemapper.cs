...
internal partial class CPointValueRemapper : CBaseEntity, IPointValueRemapper {
  ...
  public IGameTime_t PreviousUpdateTickTime {
    get => new GameTime_t(_Handle + Schema.GetOffset(0xA8CB433DB5083C83));
  }
  ...
  public ISchemaUntypedField PositionDelta {
    get => new SchemaUntypedField(_Handle + Schema.GetOffset(0xA8CB433DB249BB1C));
  }
  public IEntityIOOutput OnReachedValueZero {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xA8CB433D8746DCB5));
  }
  public IEntityIOOutput OnReachedValueOne {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xA8CB433D40852301));
  }
  public IEntityIOOutput OnReachedValueCustom {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xA8CB433DD209F610));
  }
  public IEntityIOOutput OnEngage {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xA8CB433DF404507F));
  }
  public IEntityIOOutput OnDisengage {
    get => new CEntityIOOutput(_Handle + Schema.GetOffset(0xA8CB433D22E0E24B));
  }
