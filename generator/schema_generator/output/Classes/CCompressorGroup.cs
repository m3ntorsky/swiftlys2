...
internal partial class CCompressorGroup : SchemaClass, ICompressorGroup {
  ...
  public ref CUtlVector<PointerTo<CString>> ChannelClass {
    get => ref _Handle.AsRef<CUtlVector<PointerTo<CString>>>(Schema.GetOffset(0x8D9A46F68F5E9AD5));
  }
  public ref CUtlVector<PointerTo<CString>> VariableName {
    get => ref _Handle.AsRef<CUtlVector<PointerTo<CString>>>(Schema.GetOffset(0x8D9A46F6369599AB));
  }
  ...
  public ref CUtlVector<CUtlVector<PointerTo<CString>>> ElementNames {
    get => ref _Handle.AsRef<CUtlVector<CUtlVector<PointerTo<CString>>>>(Schema.GetOffset(0x8D9A46F6D5BFAA00));
  }
